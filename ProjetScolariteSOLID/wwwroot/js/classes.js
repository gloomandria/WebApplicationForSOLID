/**
 * Gestion AJAX de la section Classes — DataTables server-side.
...
(function ($) {
    ...
    function initDt() {
        dt = $('#dt-classes').DataTable({
            ...
            columns: [
                { data: 'nom' },
                { data: 'niveau', render: function (v) { return v ? '<span class="badge bg-success">' + v + '</span>' : ''; } },
                { data: 'filiere' },
                { data: 'anneeAcademique' },
                { data: 'capaciteMax', className: 'text-center' },
