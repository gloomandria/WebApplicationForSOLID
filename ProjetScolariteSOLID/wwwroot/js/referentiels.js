/**
 * Gestion AJAX de la section Référentiels.
...
(function ($) {
    ...
    var refType  = appData.dataset.refType;
    var H        = window.AjaxHelpers;

    function refreshTable() {
        return $.get('/' + ctrl + '/Table', { type: refType })
            .done(function (html) {
    ...
    $('#btn-open-create').on('click', function () {
        ...
        loadAndWire(
            'modal-create', 'modal-create-body', '/' + ctrl + '/FormCreate?type=' + refType,
    ...
    function bindRowButtons() {
        $('.btn-edit').off('click').on('click', function () {
            ...
            loadAndWire(
                'modal-edit', 'modal-edit-body', '/' + ctrl + '/FormEdit?type=' + refType + '&id=' + $(this).data('id'),
        ...
        $('.btn-delete').off('click').on('click', function () {
            ...
            loadAndWire(
                'modal-delete', 'modal-delete-body', '/' + ctrl + '/FormDelete?type=' + refType + '&id=' + $(this).data('id'),
